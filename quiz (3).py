...
speak.say("Welcome to Visshwa quiz")
...
class Quiz:
    ...
    def buttons(self):
        ...
        speak_button = Button(gui, text="Speak",command=self.speakQuestion,width=5,bg="Red", fg="white",font=("ariel",16," bold"))
        speak_button.place(x=600,y=50)
    ...
    def display_title(self):
        title = Label(gui, text="Visshwa's QUIZ",width=50, bg="green",fg="white", font=("ariel", 20, "bold"))
    ...
    def speakQuestion(self):
        speak.say(question[self.q_no])
        speak.runAndWait()
 

gui = Tk()
gui.geometry("800x450")
gui.title("Visshwa's Quiz")
with open("C:/Users/vivia/Downloads/Quiz file (1).json") as f:
    data = json.load(f)
